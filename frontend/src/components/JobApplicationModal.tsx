...
export default function JobApplicationModal({ isOpen, onClose, jobTitle }: JobApplicationModalProps) {
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-slate-900/40 backdrop-blur-sm overflow-y-auto p-4 sm:p-6 lg:p-8 font-sans">
      <div className="bg-white rounded-2xl shadow-xl w-full max-w-4xl max-h-full overflow-y-auto flex flex-col relative">
        
        {/* Sticky Header with Close Button */}
        <div className="sticky top-0 bg-white/90 backdrop-blur-md z-10 flex justify-end p-4 pb-0">
          <button 
            onClick={onClose}
        ...
        <div className="px-8 pb-8 pt-2 sm:px-12 sm:pb-12 text-left">
          {/* Modal Header */}
          <div className="text-center mb-10">
            <h1 className="text-4xl font-serif font-bold text-[#0f172a] mb-2 tracking-tight">Job Application</h1>
